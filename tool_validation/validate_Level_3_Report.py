...
Script Name:          _validate_Level_3_Report.py
Description:          Used to validate the script tool _Level_3_Report.py. 
Date:                 09/20/2020
...
self.params[16].filter.list =   ["Altlantic Plain", 
